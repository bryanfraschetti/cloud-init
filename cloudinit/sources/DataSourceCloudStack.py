...
class DataSourceCloudStack(sources.DataSource):
        ...
        try:
            if self.perform_dhcp_setup:
                ...
                for candidate_nic in candidate_nics:
                    ...
                    LOG.debug("Trying NIC %s", candidate_nic)
                    try:
                        with network_context:
                            ...
                            LOG.debug("Obtained %s", self._obtain_password)
                            return True
    ...
    def _crawl_metadata(self):
        ...
        result = {"userdata_raw": self.userdata_raw, "metadata": self.metadata}
        return result
